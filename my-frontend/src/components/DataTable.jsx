    ...
    return (
        <div className="bg-white rounded-xl border border-gray-200 shadow-theme-sm overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-5 border-b border-gray-100">
                <h2 className="text-theme-lg font-semibold text-gray-900">Recent Projects</h2>
                ...
                <div className="relative w-full sm:w-72">
                    ...
                    <input
                        ...
                        className="block w-full pl-10 pr-3 py-2 border border-gray-200 rounded-lg leading-5 bg-gray-50 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all sm:text-sm"
                        value={searchQuery}
                        onChange={(e) => {
            ...
            <div className="flex items-center justify-between px-6 py-4 border-t border-gray-100 bg-gray-50/50">
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className="p-2 border border-gray-200 rounded-lg hover:bg-white hover:text-brand-600 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-transparent disabled:hover:text-gray-500 transition-all text-gray-500 bg-white shadow-sm"
                    >
